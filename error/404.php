...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .secondary-text-color {
      color: rgba(201, 191, 255, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="subheader primary-text-color">
		Ups. Die Seite, nach der du <br>
		suchst, existiert nicht.
	</div>
	<hr>
    ...
    <p>
      Vielleicht möchtest du zur Hauptseite zurückkehren.<br />
      Wenn du denkst, dass ein Problem besteht, melde dies bitte.
    </p>
	</div>
