...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(69, 46, 194, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
    <div class="content-container">
      <span style="color: white;">
        <img src="assets/img/favicon.ico" style="filter: brightness(0) invert(1);" width="45" height="45" class="d-inline-block align-top" alt="">
        <span style="font-size: 25px;">Mobile Task Force</span>
      </span>      
  <div class="head-line secondary-text-color">
    Keine Verbindung
  </div>
  <div class="subheader primary-text-color">
    Es konnte keine Verbindung<br>mit der Datenbank hergestellt werden.
  </div>
  <hr>
  <div class="clearfix"></div>
  <div class="context primary-text-color">
    
    <p>Wir arbeiten bereits an einer Lösung!</p>

    <br>

    <a target="_blank" class="mr-3" href="https://modern-gaming.net/legal-notice/">Impressum</a>
    <span style="margin-left: 5px; margin-right: 5px;">|</span>
    <a target="_blank" href="https://modern-gaming.net/privacy-policy/">Datenschutzerklärung</a>
